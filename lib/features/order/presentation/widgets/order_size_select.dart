...
class OrderSizeSelect extends StatefulWidget {
  ...
  const OrderSizeSelect(
      {super.key, required this.onSizeTap, required this.selectedSize});
...
class _OrderSizeSelectState extends State<OrderSizeSelect> {
        ...
        Wrap(
            ...
            children: List.generate(
                ...
                (index) => _selectableButton(() {
                    ...
                    }, sizes[index], widget.selectedSize == index))),
        Text(
  ...
  Widget _selectableButton(
          VoidCallback onPressed, String text, bool isSelected) =>
      ElevatedButton(
          onPressed: onPressed,
          style: ElevatedButton.styleFrom(
              ...
              shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(
                      color:
                          isSelected ? Colors.transparent : AppColors.primary))),
          child: Text(
            text,
            style: isSelected
